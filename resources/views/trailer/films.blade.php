                    ...
                    <div class="dropdown-menu ">
                        <div class="row">
                            <div class="col-xs-7 col-xs-offset-3">
                                ...
                                @endif
                                <a href="{{route('filters', ['genre_all', 'year_' . $selectedYear])}}"
                            ...
                            @foreach($genres as $genre)
                                <div class="col-xs-7 col-xs-offset-3">
                                    @if($selectedGenre === $genre->slug )
                                        <i class="fa fa-check" aria-hidden="true" style="color: #00C0B5"></i>
                                    @endif
                                    <a href="{{route('filters', ['genre_' . $genre->slug, 'year_' . $selectedYear])}}"
                    ...
                    <div class="dropdown-menu ">
                        <div class="row">
                            <div class="col-xs-7 col-xs-offset-3">
                                ...
                                <a href="{{route('filters', ['genre_'.$selectedGenre,'year_all'])}}"
                            ...
                            @foreach($allTrailerYears as $year)
                                <div class="col-xs-7 col-xs-offset-3">
                                    @if($selectedYear == $year ) <i class="fa fa-check" aria-hidden="true"
                                                                    style="color: #00C0B5"></i>@endif
                                    <a href="{{route('filters', ['genre_'.$selectedGenre,'year_' . $year])}}"
